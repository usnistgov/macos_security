...
| **DISA STIG** | macOS, iOS/iPadOS, visionOS | macOS: `disa_stig`<br/>iOS: `ios_stig`, `ios_stig_byoad`<br/>visionOS: `visionos_stig` |

### Industry Frameworks

| Framework | Platforms | Baseline Files |
|:----------|:----------|:---------------|
| **CIS Benchmarks (Level 1 & 2)** | macOS, iOS/iPadOS | macOS: `cis_lvl1`, `cis_lvl2`<br/>iOS: `cis_lvl1_byod`, `cis_lvl2_byod`, `cis_lvl1_enterprise`, `cis_lvl2_enterprise` |
