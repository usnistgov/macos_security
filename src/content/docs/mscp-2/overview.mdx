...
<div class="involve-grid">
  <a href="https://github.com/usnistgov/macos_security/tree/main" class="involve-item">
    <strong>Get mSCP 2.0</strong>
    <span>Try the main branch</span>
  </a>
