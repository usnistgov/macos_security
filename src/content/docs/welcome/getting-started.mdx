...
<CardGrid>
  <Card title="mSCP 2.0" icon="rocket">
...
No Ruby toolchain is required. Guidance documents are generated entirely in Python —
PDF rendering uses [typst](https://typst.app), which installs as a regular Python
dependency, so there is nothing extra to set up.
