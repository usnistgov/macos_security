...
PDF guidance is rendered with [typst](https://typst.app), which ships as a Python
dependency — there is nothing else to install. HTML and Markdown are generated in
pure Python.
