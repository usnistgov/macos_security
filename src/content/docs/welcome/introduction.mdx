...
<div class="framework-grid">
  <div class="framework-category">
    ...
    <ul>
      ...
      <li><a href="https://dodcio.defense.gov/CMMC/">CMMC 2.0</a> <span class="levels">Level 1, Level 2, Level 3 (iOS only)</span></li>
  ...
  <div class="framework-category">
    ...
    <ul>
      ...
      <li><a href="https://hhscyber.hhs.gov/cornerstone-hicp.html">HHS</a> <span class="levels">HICP - Large Practice</span></li>
    </ul>
  </div>
  <div class="framework-category">
    <h4>International</h4>
    <ul>
      ...
      <li><a href="https://www.bio-overheid.nl/category/producten/bio">BIO</a> <span class="levels">NLMAPGOV Base<br/>NLMAPGOV Plus</span></li>
    </ul>
  </div>
</div>
