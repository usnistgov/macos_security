...
(`Baseline`, `Macsecurityrule`, `Payload`, `LoguruFormatter`), the
command-line entry point `parse_cli`, the generator entry points
(`baseline`, `guidance`, `mapping`, `translation`), and the file / config
