...
def main():
    ...
    # found_srgs = []
    # missing_srgs = []
    # for _s in stig_data_yaml:
    #     srg_list = _s['SRGID'].split(",")
    #     for _srg in srg_list:
    #         if any(_srg in rule.rule_srg for rule in found_rules):
    #             if _srg not in found_srgs:
    #                 found_srgs.append(_srg)
    #         else:
    #             if _srg not in missing_srgs:
    #                 missing_srgs.append(_srg)



    # for _srg in found_srgs:
    #     for _s in stig_data_yaml:
    #         if _srg in _s['SRGID']:
    #             # get the rules that we map this SRG to
    #             print(f'{_s["STIGID"]} - {_s["SRGID"]} - {_s["Requirement"]}')
    #             get_rule_from_stig_id(_s['STIGID'], _s["SRGID"].split(','), found_rules)
    #             break
    ...
    #     for _s in stig_data_yaml:
    #         if _srg in _s['SRGID']:
    #             print(f'{_s["STIGID"]} - {_s["Requirement"]}')
