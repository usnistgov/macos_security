...
```yaml
title: "macOS 15.0: Security Configuration - MYORGS_BENCHMARK (Tailored from STIG)"
description: |
  This guide describes the actions to take when securing a macOS 15.0 system against the MYORGS_BENCHMARK (Tailored from STIG) security baseline.
authors: |
