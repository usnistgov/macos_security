...
parser.add_argument(
    "--plist", "-p", type=validate_file, help="Input plist scan", required=True
)
...
with open(htmlsavefile, "r") as original:
    data = original.read()
with open(htmlsavefile, "w") as modified:
    modified.write(html + data + endhtml)
