image::config/default/images/mscp_banner_outline.png[]
// settings:
:idprefix:
:idseparator: -
...
To learn more about the project, please see the https://pages.nist.gov/macos_security/[macOS Security Compliance Project Documentation].
