...
This project is the technical implementation of NIST Special Publication, 800-219 Rev. 1 https://csrc.nist.gov/pubs/sp/800/219/r1/final[Automated Secure Configuration Guidance from the macOS Security Compliance Project (mSCP)].  NIST Special Publication 800-219 Rev. 1 is the official guidance for automated secure configuration for macOS.
