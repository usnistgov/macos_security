...
|Document Number or Descriptor
|Document Title
|link:https://dl.dod.cyber.mil/wp-content/uploads/stigs/zip/U_Apple_visionOS_26_Y26M02_STIG.zip[STIG Ver 1, Rel 1]|_Apple visionOS 26 STIG - Ver 1, Rel 1_
|===
...
|Document Number or Descriptor
|Document Title
|link:https://www.cisecurity.org/benchmark/apple_ios[Apple iOS/iPadOS]|_CIS Apple iOS 26 and iPadOS 26 Version 1.0.0_
|===