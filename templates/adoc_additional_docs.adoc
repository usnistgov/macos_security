...
|Document Number or Descriptor
|Document Title
|link:https://dl.dod.cyber.mil/wp-content/uploads/stigs/zip/U_Apple_OS_X_10-15_V1R4_STIG.zip[STIG Ver 1, Rel 4]|_Apple OS X 10.15 (Catalina) STIG_
|===
...
|link:https://developer.apple.com/documentation/devicemanagement/profile-specific_payload_keys[AProfile-Specific Payload Keys]|_Profile-Specific Payload Keys_
